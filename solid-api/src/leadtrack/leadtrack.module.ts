...
import { LeadStageBootstrapProvider } from './providers/lead-stage-bootstrap.provider';
import { LeadStageWorkflowFieldDataProvider } from './providers/lead-stage-workflow-field-data.provider';
import {
...
@Module({
  ...
  providers: [
    ...
    LeadStageBootstrapProvider,
    LeadStageWorkflowFieldDataProvider,
    PipelineFunnelProvider,
    PipelineValueProvider,
    LeadsBySourceProvider,
    RepLeaderboardProvider,
